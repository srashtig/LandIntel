...
| **CHIRPS v3 daily** (`UCSB-CHC/CHIRPS/V3/DAILY`) + **IMD 0.25° gridded daily** | GEE (CHIRPS) + local NetCDF (IMD), live/local | `rainfall` — annual + monsoon-season totals, rain days, wettest day, 3-year (2023-2025) history | Two independent estimates shown side by side (they can disagree); no true monthly breakdown yet. |
